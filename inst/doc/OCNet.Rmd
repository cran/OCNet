...
* **Cooling schedule**: 
  + *cold*: corresponds to `coolingRate = 200`, `initialNoCoolingPhase = 0`;
  + *default*: corresponds to default values `coolingRate = 50`, `initialNoCoolingPhase = 0`;
  + *hot*: corresponds to `coolingRate = 20`, `initialNoCoolingPhase = 0.15`.
* **iter**: equal to `nIter/dimX/dimY`.
...
| name            | dimX | dimY | No. of outlets | Periodic Boundaries | Initial State | Cooling Schedule | Cellsize |iter | seed | On CRAN? |
| ----------:|:------:|:------:|:----------:|:-------------------:|:-------------:|:----------------:|:--------:|:---:|:----:|:-----:|
|`OCN_4`^[This is actually not an OCN, but was rather generated manually for illustration purposes.]     |   4    |   4    |    1       |      FALSE          |              |                   |  1       |     |      | Yes   |
|`OCN_20`         |   20   |   20   |    1       |      FALSE          |   I           |  default         |  1       |  30 |  1   | Yes   |
|`OCN_250`        |   250  |   250  |    1       |      FALSE          |   I           |  default         |  1       |  30 |  2   | No   |
|`OCN_250_T`      |   250  |   250  |    1       |      FALSE          |   T           |  default         |  1       |  30 |  2   | Yes    |
|`OCN_250_V`      |   250  |   250  |    1       |      FALSE          |   V           |  default         |  1       |  30 |  2   | No    |
|`OCN_250_cold`   |   250  |   250  |    1       |      FALSE          |   I           |  cold            |  1       |  30 |  2   | No    |
|`OCN_250_hot`    |   250  |   250  |    1       |      FALSE          |   I           |  hot             |  1       |  30 |  2   | No    |
|`OCN_250_V_cold` |   250  |   250  |    1       |      FALSE          |   V           |  cold            |  1       |  30 |  2   | No    |
|`OCN_250_V_hot`  |   250  |   250  |    1       |      FALSE          |   V           |  hot             |  1       |  30 |  2   | No    |
|`OCN_250_PB`     |   250  |   250  |    1       |      TRUE           |   I           |  default         |  1       |  30 |  2   | Yes   |
|`OCN_rect1`      |   450  |   150  |    1       |      FALSE          |   I           |  default         |  1       |  30 |  3   | No    |
|`OCN_rect2`      |   150  |   450  |    1       |      FALSE          |   I           |  default         |  1       |  30 |  3   | No    |
|`OCN_300_diag`   |   300  |   300  |    1^[`OutletPos = 1`.]       |      FALSE          |   V           |  default         |  50      |  30 |  4   | No    |
|`OCN_300_4out`   |   300  |   300  |   4^[`OutletSide = c("S","N","W","E")`, `OutletPos = c(1,300,149,150)`.] | FALSE | V | default | 50 | 30 | 5 | Yes |
|`OCN_300_4out_PB`|   300  |   300  |   4^[`OutletSide = c("S","N","W","E")`, `OutletPos = c(1,300,149,150)`.] | TRUE | V | default | 50 | 30 | 5 | Yes |
|`OCN_300_7out`   |   300  |   300  |   7 | FALSE | V | default | 50 | 30 | 5 | No |
|`OCN_400_T_out`  |   400  |   400  |   1 | FALSE | T | hot | 50 | 40 | 7 | No |
|`OCN_400_Allout` |   400  |   400  | All | FALSE | H | hot | 50 | 40 | 8 | Yes |
|`OCN_500_V_hot`  |   500  |   500  |   1 | FALSE | T | hot | 50 | 40 | 9 | No |
|`OCN_500_PB_hot` |   500  |   500  |   1 | TRUE  | V | hot | 50 | 40 | 10 | No |
